...
class Captcha {
	...
	*/
	...
	function Captcha()
	{
		...
		$this->gd_font_file  = $_SERVER['DOCUMENT_ROOT'].'/framework/static/automatic.gdf';
		$this->use_gd_font   = false;
//		$this->gd_font_size  = 24;
		$this->gd_font_size  = 32;
		$this->text_x_start  = 15;

		$this->ttf_file      = $_SERVER['DOCUMENT_ROOT'].'/framework/static/AHGBold.ttf';
...
//		$this->text_color       = new Securimage_Color(0x3d, 0x3d, 0x3d);
		$this->text_color       = new Securimage_Color(0x11, 0x11, 0x11);
...
//		$this->line_color           = new Securimage_Color(0x3d, 0x3d, 0x3d);
		$this->num_lines			= 8;
		$this->line_color			= new Securimage_Color(0x88, 0x99, 0xaa);
//		$this->draw_lines_over_text = true;
	...
	function saveData()
	{
		...
		$context->session->captcha = $this->code;
	}
