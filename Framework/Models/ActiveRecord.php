...
use Framework\Core\Exceptions;
use Framework\Core\Interfaces\EventHandler;
...
abstract class ActiveRecord implements EventHandler{
    ...
    protected static function getAdapter(){
        $className = sprintf("Framework\Models\Adapters\%sAdapter", static::$adapterClass);
     ...
     * @param $attr
     * @return mixed
     * @throws \Framework\Core\Exceptions\UnknownPropery
     */
